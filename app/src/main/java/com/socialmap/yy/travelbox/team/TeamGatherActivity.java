...
public class TeamGatherActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        location_text = (EditText)this.findViewById(R.id.location_text);

        setDateTime();
        setTimeOfDay();

        Intent intent = this.getIntent();
        teamlocal = intent.getStringExtra("teamlocal");
        location_text.setText(teamlocal);
        ...
        location_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TeamGatherActivity.this,ChooseMapActivity.class);
