 ...
 */
package com.socialmap.yy.travelbox.module.chat.switcher;
...
public class Switch extends CompoundButton {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        final TypedArray appearance = context.obtainStyledAttributes(resid, R.styleable.SwitchTextAppearance);

        ColorStateList colors;
        int ts;

        colors = appearance.getColorStateList(R.styleable.SwitchTextAppearance_android_textColor);
        if (colors != null) {
            mTextColors = colors;
        } else {
        ...
        ts = appearance.getDimensionPixelSize(R.styleable.SwitchTextAppearance_android_textSize, 0);
        if (ts != 0) {
        ...
        typefaceIndex = appearance.getInt(R.styleable.SwitchTextAppearance_android_typeface, -1);
        styleIndex = appearance.getInt(R.styleable.SwitchTextAppearance_android_textStyle, -1);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mThumbWidth = (int) (maxTextWidth + mThumbTextPadding * 2.5);//fix by liweiping from 2-->2.5
