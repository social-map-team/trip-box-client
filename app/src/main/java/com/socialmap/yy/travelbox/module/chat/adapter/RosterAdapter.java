package com.socialmap.yy.travelbox.module.chat.adapter;
...
public class RosterAdapter extends BaseExpandableListAdapter implements
	...
	private static final String COUNT_MEMBERS = "SELECT COUNT() FROM "
			...
			+ " WHERE inner_query." + RosterProvider.RosterConstants.GROUP + " = "
			+ RosterProvider.QUERY_ALIAS + "." + RosterProvider.RosterConstants.GROUP;
	...
	public void requery() {
		...
		Cursor groupCursor = mContentResolver.query(RosterProvider.GROUPS_URI,
				GROUPS_QUERY_COUNTED, selectWhere, null, RosterProvider.RosterConstants.GROUP);
		groupCursor.moveToFirst();
		while (!groupCursor.isAfterLast()) {
			Group group = new Group();
			group.setGroupName(groupCursor.getString(groupCursor
					.getColumnIndex(RosterProvider.RosterConstants.GROUP)));
