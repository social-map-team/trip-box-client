...
package com.socialmap.yy.travelbox.chat.swipeback;
...
public class ViewDragHelper {
	 ...
	 * callback's
	 * {@link  com.socialmap.yy.travelbox.chat.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link  com.socialmap.yy.travelbox.chat.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 * {@link  com.socialmap.yy.travelbox.chat.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
	 ...
	 * {@link  com.socialmap.yy.travelbox.chat.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
	 * .
	 * 
	 * @param x
	 *            X position to test in the parent's coordinate system
