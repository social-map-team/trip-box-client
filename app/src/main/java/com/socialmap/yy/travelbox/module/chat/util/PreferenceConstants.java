package com.socialmap.yy.travelbox.module.chat.util;

public class PreferenceConstants {
	public static final String GMAIL_SERVER = "192.168.1.100";
	...
	public final static String CUSTOM_SERVER = "192.168.1.100";
    ...
    public final static String SOSCHECK = "soscheck";
